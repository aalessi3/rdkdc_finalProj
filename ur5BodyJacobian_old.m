function J = ur5BodyJacobian_old(theta)
...
u2 = [
 L4*cos(theta5)*cos(theta6) - L2*cos(theta4)*sin(theta6) - L5*sin(theta5)*sin(theta6) - L1*cos(theta3)*cos(theta4)*sin(theta6) - L2*cos(theta5)*cos(theta6)*sin(theta4) + L1*sin(theta3)*sin(theta4)*sin(theta6) - L1*cos(theta3)*cos(theta5)*cos(theta6)*sin(theta4) - L1*cos(theta4)*cos(theta5)*cos(theta6)*sin(theta3);...
 L1*cos(theta6)*sin(theta3)*sin(theta4) - L4*cos(theta5)*sin(theta6) - L5*cos(theta6)*sin(theta5) - L1*cos(theta3)*cos(theta4)*cos(theta6) - L2*cos(theta4)*cos(theta6) + L2*cos(theta5)*sin(theta4)*sin(theta6) + L1*cos(theta3)*cos(theta5)*sin(theta4)*sin(theta6) + L1*cos(theta4)*cos(theta5)*sin(theta3)*sin(theta6);...
                                                                                                                                                                                                                                                               sin(theta5)*(L1*sin(theta3 + theta4) - L4 + L2*sin(theta4));...
...
u3 = [
 L4*cos(theta5)*cos(theta6) - L2*cos(theta4)*sin(theta6) - L5*sin(theta5)*sin(theta6) - L2*cos(theta5)*cos(theta6)*sin(theta4);...
 L2*cos(theta5)*sin(theta4)*sin(theta6) - L4*cos(theta5)*sin(theta6) - L5*cos(theta6)*sin(theta5) - L2*cos(theta4)*cos(theta6);...
                                                                                            -sin(theta5)*(L4 - L2*sin(theta4));...
                                                                                                       cos(theta6)*sin(theta5);...
                                                                                                      -sin(theta5)*sin(theta6);...
                                                                                                                   cos(theta5)];

u4 = [
   L4*cos(theta5)*cos(theta6) - L5*sin(theta5)*sin(theta6);...
